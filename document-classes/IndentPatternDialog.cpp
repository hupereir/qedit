...
CustomDialog( parent )
{
    ...
    grid_layout->addWidget( patternType_ = new IndentPatternType( this ) );

    // scale
    grid_layout->addWidget( new QLabel( "Scale: ", this ) );
    grid_layout->addWidget( scaleSpinBox_ = new QSpinBox( this ) );
    scaleSpinBox_->setMinimum(0);
    scaleSpinBox_->setMaximum(10);
    scaleSpinBox_->setValue(0);
...
void IndentPatternDialog::setPattern( const IndentPattern& pattern )
{
    ...
    scaleSpinBox_->setValue( pattern_.scale() );
...
IndentPattern IndentPatternDialog::pattern( void )
{
    ...
    pattern_.setScale( scaleSpinBox_->value() );
