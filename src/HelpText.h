...
static const QString helpText[] = {
    ...
    //_________________________________________________________
    QObject::tr( "Logical block markers" ),
    QObject::tr( "<h2>Logical block markers</h2>\n"
    "\n"
