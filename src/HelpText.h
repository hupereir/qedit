...
static const char* HelpText[] = {
  ...
  ""
  "<h3>Tools menu</h3>"
  "<p>The Tools menu provides high-level text modification macros and edition utilities that are common to all document classes. Such macros apply to large portion of the text and perform actions such as text indentation, spell checking (via a pop-up dialog), diff of opened files, etc.</p>"
  ""
  "<h3>Macro menu</h3>"
  ...
  ""
  "<h3>Windows menu</h3>"
  "<p>The Windows menu provides information about the active  edit file and fast access to all other edited files in the session.</p>"
  ""
  "<h3>Help menu</h3>"
  ...
  ""
  "<p>The syntax used for regular expression is documented elsewhere on the web and notably in the Qt on-line documentation page. ",
  ...
  "--tabbed               opens files in same window<br>"
  "--diff                 opens files in same window and perform diff<br>"
  ...
  "--close                close displays matching file names and exit<br>"
